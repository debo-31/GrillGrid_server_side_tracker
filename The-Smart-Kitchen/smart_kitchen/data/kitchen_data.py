...
KITCHEN_SCENARIOS = {
    ...
    "busy_restaurant": {
        ...
        "available": [2, 3, 1, 3, 3, 1],
        "max_needs": [
            [1, 2, 1, 1, 1, 1],  # Head Chef
            [1, 1, 1, 1, 1, 0],  # Sous Chef
    ...
    "deadlock_scenario": {
        ...
        "available": [0, 0, 0, 1, 0],  # Very limited available equipment
        "max_needs": [
            [1, 1, 0, 1, 1],  # Head Chef
            [1, 1, 0, 1, 1],  # Sous Chef
